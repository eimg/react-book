...
const TELEMETRY_KEY_SALT=`telemetry.salt`;const{NEXT_TELEMETRY_DISABLED,NEXT_TELEMETRY_DEBUG}=process.env;class Telemetry{constructor({distDir}){this.conf=void 0;this.sessionId=void 0;this.rawProjectId=void 0;this.queue=void 0;this.notify=()=>{if(this.isDisabled||!this.conf){return;}// The end-user has already been notified about our telemetry integration. We
